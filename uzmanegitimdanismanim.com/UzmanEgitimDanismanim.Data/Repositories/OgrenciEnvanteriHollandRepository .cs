...
{
    public class OgrenciEnvanteriHollandRepository : Repository<OgrenciEnvanteriHolland>, IOgrenciEnvanteriHollandRepository
    {
        public OgrenciEnvanteriHollandRepository(SqlDbContext context) : base(context)
        {
        }
